...
if ( typeof define === "function" && define.amd ) {
  define( "jquery", [], function() {
    return jQuery;
                     ...
                     return s.preventDefault(),e(this).closest(".item").next().hasClass("postcard")?void e(this).closest(".item").addClass("hidden").next().removeClass("hidden").addClass("animated fadeIn"):void e(this).closest(".item").addClass("hidden").next().removeClass("hidden").addClass("animated flipInY")}
                     )}
                     )}
                     (jQuery);
